...
/**
 * The optional (parallel) GoLive phase merges the output shards of the previous phase into a set of
...
class GoLive {
  ...
  public boolean goLive(Options options, FileStatus[] outDirs) {
    ...
    ThreadPoolExecutor executor =
        new ThreadPoolExecutor(concurrentMerges, concurrentMerges, 1, TimeUnit.SECONDS,
            new LinkedBlockingQueue<Runnable>());

    try {
      CompletionService<Request> completionService =
          new ExecutorCompletionService<Request>(executor);
