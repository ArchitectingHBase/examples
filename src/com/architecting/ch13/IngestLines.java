  ...
  public static void processVersion2() {
    ...
    PairFunction<String, String, String> linesplit = new PairFunction<String, String, String>() {
      public Tuple2<String, String> call(String s) {
        int index = s.indexOf("|");
        return new Tuple2<String, String>(s.substring(0, index), s.substring(index + 1));
      }
    };
    ...
    JavaRDD<Put> keyValuesPuts = keyValues.map(new Function<Tuple2<String, List<String>>, Put>() {
      @Override
      public Put call(Tuple2<String, List<String>> v1) throws Exception {
        ...
        while (iterator.hasNext()) {
          ...
          put.addColumn(COLUMN_FAMILY, Bytes.toBytes(columnQualifier), Bytes.toBytes(value));
        }
        return put;
      }
    });
