...
public class Merge {
  ...
  public static void main(String[] args) throws MasterNotRunningException, ZooKeeperConnectionException, IOException {
    ...
    List<HRegionInfo> regions = admin.getTableRegions(TableName.valueOf("testtable")); // <1>
    ...
    for (int index = 0; index < regions.size() / 2; index++) {
      ...
      admin.mergeRegions(region1.getEncodedNameAsBytes(), region2.getEncodedNameAsBytes(), false); // <2>
    }
    admin.close();
    // end::MERGE1[]
  }
